...
import portraitTransparent from '../assets/images/lin_qiongni_portrait_transparent.webp';
...
export const HeroDark: React.FC = () => {
  ...
  return (
    <section id="hero-section" className="luxury-hero relative min-h-screen overflow-hidden pt-24 md:pt-36">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-8 px-6 pb-10 sm:gap-10 sm:px-12 md:min-h-[calc(100vh-9rem)] lg:grid-cols-[1fr_.92fr]">
        ...
        <div className="lg:-translate-y-36">
          <motion.div initial={{ opacity: 0, x: 26 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: .95, delay: .12 }} className="relative flex min-h-[300px] items-end justify-center sm:min-h-[430px] lg:min-h-[720px]">
            ...
            <img
              ...
              loading="eager"
              decoding="async"
              className="luxury-portrait relative z-10 max-h-[40vh] w-auto max-w-full object-contain object-bottom sm:max-h-[56vh] lg:max-h-[78vh]"
            />
            <div className="absolute bottom-[7%] left-[8%] z-20 hidden border-l border-[#C9A86A] pl-4 sm:block"><p className="text-[9px] uppercase tracking-[.22em] text-[#D7BA7F]">Legal Counsel</p><p className="mt-2 text-xs text-[#CFD7DF]">合同 · 合规 · 争议解决</p></div>
          </motion.div>
        </div>
      </div>
    </section>
