...
(function(){
  ...
  function renderHome(){
    ...
    document.getElementById('app').innerHTML =
      ...
      '<p><span class="pill">Season 2</span>用《傲骨贤妻》第二季（1–10 集）系统学习英美法律英语。每集含：真实场景台词（法律术语高亮可点击）、术语卡（英文释义 + 中文对应）、完整英文字幕、英美制度对照。</p>' +
  ...
  function renderEpisode(id, focus){
    ...
    var trHtml = tr.length ? tr.map(function(l){
      var sp = l.sp ? '<div class="sp">'+escapeHtml(l.sp)+'</div>' : '<div class="sp muted">—</div>';
      return '<div class="tr-line'+(l.sp?'':' no-sp')+'">'+sp +
    ...
    document.getElementById('app').innerHTML =
      ...
      '<div class="section"><h2><span class="en">Full transcript</span> · 完整英文字幕</h2>' +
        ...
        '<div class="tr-wrap" id="trWrap"><div class="tr-meta">英文原文字幕 · 术语同样高亮可点击。仅供个人学习（fair use）。原始字幕仅在部分行标注角色名，未标注处显示「—」。</div>' +
